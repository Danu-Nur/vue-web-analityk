...
<template>
    <footer class="">
        <div class="container px-4 pt-16 pb-6 mx-auto lg:px-8 lg:pt-24">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div>
                    <div class="flex justify-center text-red-600 sm:justify-start dark:text-red-300">
                        <ApplicationLogo/>

                    </div>

                    <p
                        class="max-w-md mt-6 leading-relaxed text-center text-gray-500 sm:max-w-xs sm:text-left dark:text-gray-400">
                ...
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                    ...
                    <div class="text-center sm:text-left">
                        ...
                        <ul class="mt-8 space-y-4 text-sm">
                            ...
                            <li>
                                <a class="group flex justify-center gap-1.5 sm:justify-start rtl:sm:justify-end"
                                    href="#">
                                    <span
                                    ...
                                    <span class="relative flex size-2">
                                        ...
                                        <span class="relative inline-flex bg-red-500 rounded-full size-2"></span>
                                    </span>
                                </a>
                            </li>
                        </ul>
                            ...
                            <li>
                                <a class="flex items-center justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="text-gray-900 size-5 shrink-0 dark:text-white" fill="none"
            ...
            <div class="pt-6 mt-12 border-t border-gray-100 dark:border-gray-800">
                <div class="text-center sm:flex sm:justify-between sm:text-left">
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <a class="inline-block text-red-600 underline transition hover:text-red-600/75 dark:text-red-500 dark:hover:text-red-500/75"
                            href="#">
                            Terms & Conditions
                        </a>
