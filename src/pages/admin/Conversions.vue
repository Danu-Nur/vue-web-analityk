...
const loadData = async () => {
    ...
    if (!hasFetchedData.value && !conversionStore.funnelOverview) {
        try {
            hasFetchedData.value = true; // Set true segera setelah memulai fetch
            await conversionStore.fetchAllData();
        } catch (err) {
...
<template>
    ...
    <section class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:mb-6">
            ...
            <div class="h-full flex flex-col justify-center">
                <div class="flex justify-between items-end">
                    <div>
                        ...
                        <p class="text-2xl font-bold">{{ conversionStore.funnelOverview.total_users }}</p>
                    </div>
                    <div class="text-right">
                        <p class="text-gray-500 text-sm">Converted</p>
                        <p class="text-2xl font-bold text-grey-600">
                            {{ conversionStore.funnelOverview.converted_percentage }}%</p>
                    </div>
                </div>
                <div class="mt-4">
                    <div class="h-2 w-full bg-gray-200 rounded-full overflow-hidden">
                        <div class="h-full bg-gradient-to-r from-blue-400 to-gray-600 rounded-full"
                            :style="{ width: `${conversionStore.funnelOverview.converted_percentage}%` }">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="rounded-2xl border border-gray-200 shadow-sm p-6 transition-all">
            <div class="flex justify-between items-start mb-4">
                ...
                <div class="flex items-center text-sm">
                    ...
                    <span class="text-green-500">+{{ conversionStore.conversionRate.change_percentage }}%</span>
                </div>
            </div>
            <div class="flex justify-center items-center h-32">
                <svg class="w-30 h-30" viewBox="0 0 36 36">
                    <path d="M18 2.0845
            ...
            <div class="flex justify-between text-sm mt-2">
                <span class="text-gray-500">Last week: {{ conversionStore.conversionRate.last_week_rate }}%</span>
        ...
        <div class="rounded-2xl border border-gray-200 shadow-sm p-6 transition-all">
            ...
            <div class="space-y-4 overflow-y-auto max-h-[200px]">
                <div>
                    ...
                    <div class="h-2 w-full bg-gray-200 rounded-full overflow-hidden">
                        <div class="h-full bg-gradient-to-r from-amber-400 to-gray-600 rounded-full" style="width: 42%">
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="h-2 w-full bg-gray-200 rounded-full overflow-hidden">
                        <div class="h-full bg-gradient-to-r from-blue-400 to-gray-600 rounded-full" style="width: 28%">
                        </div>
                    </div>
                </div>
                <div>
        ...
        <div class="rounded-2xl border border-gray-200 shadow-sm p-6 transition-all">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="h-2 w-full bg-gray-200 rounded-full overflow-hidden">
                        <div class="h-full bg-gradient-to-r from-gray-400 to-gray-600 rounded-full" style="width: 12%">
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="h-2 w-full bg-gray-200 rounded-full overflow-hidden">
                        <div class="h-full bg-gradient-to-r from-gray-400 to-gray-600 rounded-full" style="width: 34%">
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="h-2 w-full bg-gray-200 rounded-full overflow-hidden">
                        <div class="h-full bg-gradient-to-r from-gray-400 to-gray-600 rounded-full" style="width: 28%">
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="h-2 w-full bg-gray-200 rounded-full overflow-hidden">
                        <div class="h-full bg-gradient-to-r from-gray-400 to-gray-600 rounded-full" style="width: 18%">
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="h-2 w-full bg-gray-200 rounded-full overflow-hidden">
                        <div class="h-full bg-gradient-to-r from-gray-400 to-gray-600 rounded-full" style="width: 8%">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <Suspense>
                    <template #default>
                        <AreaChartTrends :title="areaConversionTrends.title"
                            :categories="areaConversionTrends.categories" :seriesData="areaConversionTrends.seriesData"
                            :height="300" />
                    </template>
                    <template #fallback>
                        <SkeletonChart chartType="bar" />
