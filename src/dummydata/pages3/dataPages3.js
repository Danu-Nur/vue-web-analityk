export const clickEvents = {
    title: 'Top Click',
    categories: ['#btn-buy','#btn-add-cart','.product-item','#nav-menu','.search-bar','#btn-login','.category-link','#btn-signup','.footer-link','#video-play','.social-icon','#btn-contact','.promo-banner','#btn-search','.user-profile','#btn-help','.cart-icon','#btn-share','.language-switch','#btn-faq','.newsletter-signup','#btn-feedback','.privacy-link','#btn-terms','.support-chat',],
    seriesData: [342, 215, 189, 145, 130, 98, 87, 76, 65, 54, 43, 39, 32, 28, 25, 22, 19, 17, 15, 13, 11, 9, 8, 7, 6,],
    headers: [
...
export const heatmapData = {
    ...
    items: [
        { x: 100, y: 150, clicks: 50 },
        { x: 100, y: 150, clicks: 10 },
        { x: 200, y: 250, clicks: 45 },
        { x: 300, y: 350, clicks: 40 },
        { x: 400, y: 450, clicks: 350 },
        { x: 500, y: 550, clicks: 30 },
        { x: 600, y: 650, clicks: 28 },
        { x: 700, y: 750, clicks: 25 },
        { x: 800, y: 850, clicks: 22 },
        { x: 900, y: 950, clicks: 20 },
        { x: 150, y: 200, clicks: 18 },
        { x: 250, y: 300, clicks: 16 },
        { x: 350, y: 400, clicks: 14 },
        { x: 450, y: 500, clicks: 1200 },
        { x: 550, y: 600, clicks: 100 },
        { x: 650, y: 700, clicks: 9 },
        { x: 750, y: 800, clicks: 8 },
        { x: 850, y: 900, clicks: 7 },
        { x: 120, y: 180, clicks: 6 },
        { x: 220, y: 280, clicks: 5 },
        { x: 320, y: 380, clicks: 4 },
        { x: 420, y: 480, clicks: 3 },
        { x: 520, y: 580, clicks: 3 },
        { x: 620, y: 680, clicks: 2 },
        { x: 720, y: 780, clicks: 2 },
        { x: 820, y: 880, clicks: 2 },
        { x: 170, y: 230, clicks: 1 },
        { x: 270, y: 330, clicks: 1 },
        { x: 370, y: 430, clicks: 1 },
        { x: 470, y: 530, clicks: 1 },
        { x: 570, y: 630, clicks: 1 }
    ]
};
