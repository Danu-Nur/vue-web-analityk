...
const SummaryCards = defineAsyncComponent(() => import('./SummaryCards.vue'));
...
<template>
    ...
    <section aria-label="Main content" class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6 mb-6">
        <article aria-label="Visitor Country Distribution" class="card-new sm:col-span-3 rounded-lg p-4">
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <Suspense>
                    <template #default>
                        <MapChoroplethAsync v-if="overviewStore.geoMap && overviewStore.geoMap.length > 0"
                            :data="overviewStore.geoMap" class="h-[450px]" />
                ...
                <div class="md:ms-4 mt-4 md:mt-0">
                    <Suspense>
                        <template #default>
                            <Datatable v-if="overviewStore.headers.geoMap && overviewStore.geoMap"
                                ...
                                title="Visitor Countries" class="h-full" />
        ...
        <article aria-label="Device Type Distribution" class="card-new rounded-lg p-4">
    ...
    <section aria-label="Main content" class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6 mb-6">
        <article aria-label="Referrer / UTM Source" class="card-new rounded-lg p-4">
        ...
        <article aria-label="Entry / Exit Pages" class="card-new rounded-lg p-4">
        ...
        <article aria-label="Top Pages" class="card-new sm:col-span-2 rounded-lg p-4">
